    ...
    <div class="flex flex-col h-screen w-screen overflow-hidden bg-gray-100">
        ...
        <div class="flex flex-col md:flex-row flex-1 min-h-0">
            ...
            <div class="relative flex-1 min-h-0">
                <ClientOnly>
                    <LeafletMap :quartiere="quartiere" :selected-id="selectedId" mode="action" class="w-full h-full"
                        @select="handleSelect" />
                    <template #fallback>
            ...
            <div class="hidden md:flex flex-col w-80 xl:w-96 flex-shrink-0 border-l border-gray-200 shadow-xl">
                <ActionPanel :quartiere="quartiere" :selected-id="selectedId" :loading="loading" :error="error"
